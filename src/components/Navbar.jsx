...
function Navbar() {
  ...
  const credit = sessionStorage.getItem("days");
  console.log(credit);
        ...
        <nav className="navbarNav">
            <ul className="navbarListItems">
                ...
                <li className="navbarListItem" onClick={() => navigate('/explore')}>
                    ...
                    <p className={pathMatchRoute('/offers') ? 'navbarListItemNameActive' : 'navbarListItemName'}>Gyms</p>
                </li>
                <li className="navbarListItem" onClick={() => navigate(`/profile/${credit}`)}>
